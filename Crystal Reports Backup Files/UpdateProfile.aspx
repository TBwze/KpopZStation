<%@ Page Title="" Language="C#" MasterPageFile="~/View/Nav.Master" AutoEventWireup="true" CodeBehind="UpdateProfile.aspx.cs" Inherits="ProjectLabPSDT.View.UpdateProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:Button ID="updateUser" runat="server" Text="Update Profile" Onclick="updateUser_Click"/>
</asp:Content>
